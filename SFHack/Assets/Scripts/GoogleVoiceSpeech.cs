		...
		void OnGUI() 
		{
				...
				if(micConnected)
				{
						...
						if(!Microphone.IsRecording(null))
						{
								...
								if(OVRInput.Get(OVRInput.Button.One, controller))//GUI.Button(new Rect(Screen.width/2-100, Screen.height/2-25, 200, 50), "Record"))
						...
						else //Recording is in progress
						{
								...
								if(OVRInput.Get(OVRInput.Button.One, controller) == false)//GUI.Button(new Rect(Screen.width/2-100, Screen.height/2-25, 200, 50), "Stop and Play!"))
                {
